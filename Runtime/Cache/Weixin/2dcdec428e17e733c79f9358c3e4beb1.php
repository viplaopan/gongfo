...
<body>
	<div class="pagebox">
		...
		<div class="joss">
			<img src="/Public/Weixin/pic/fo2.png" alt="佛像">
		</div>
		<div class="light">
		...
		<div class="vase">
			<img src="/Public/Weixin/pic/hph<?php echo ($hpno); ?>.png" alt="花瓶">
		</div>
		<div class="vase two">
			<img src="/Public/Weixin/pic/hph<?php echo ($hpno); ?>.png" alt="花瓶">
		</div>
		<div class="compote">
			<img src="/Public/Weixin/pic/gph<?php echo ($gpno); ?>.png" alt="果盘">
		</div>
		...
		<div class="censer">
			<div class="smoke"></div>
			<img src="/Public/Weixin/pic/xlh<?php echo ($xlno); ?>.png" alt="香炉">
		</div>
		<div class="bottle">
			<img src="/Public/Weixin/pic/zs.png" alt="中水">
		</div>	
		<ul class="nav">
